...
if ($env:BICEP_MODULE_SUBSCRIPTION_ID -ne '') {
  Write-Output "Set Az Context to the bicep module subscription '$env:BICEP_MODULE_SUBSCRIPTION_ID'."
  Set-AzContext -SubscriptionId $env:BICEP_MODULE_SUBSCRIPTION_ID
}
