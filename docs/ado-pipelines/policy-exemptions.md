# Azure DevOps Pipelines for Azure Policy Exemptions


## Overview

The [Policy Exemptions Azure DevOps Pipeline](../../.azuredevops/pipelines/policies/azure-pipelines-policy-exemptions.yml) deploys all required policy exemptions to the target Azure environments.
...
![Policy Exemptions Tests Results](../images/ado-pipeline-policy-exemptions-test-results.png)
...
It deploys the policy exemptions Bicep template generated from the `Build Dev` stage upon successful completion of the `Test Dev` stage.
