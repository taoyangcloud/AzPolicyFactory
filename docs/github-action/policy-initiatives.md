...
![Policy Initiatives Workflow](../images/github-worfklow-policy-initiatives.png)
...
These jobs use the custom action [build-policy-def](../../.github/actions/templates/build-policy-def/action.yml) to populate the paths of each policy initiative JSON files and add them to the Policy Initiative Bicep template file.
